...
public class SmartContractRecord  extends GridPane{
    ...
    public SmartContractRecord(Stage arg0) {
    	// TODO Auto-generated method stub
    			arg0.setTitle("UTOPIAN PAWN SHOP SMART CONTRACT");
    			//arg0.setMaxHeight(800);
    			//arg0.setMinWidth(600);
    			smartGridPane = createGridPane();
    			smartGridPane.setMaxHeight(arg0.getMaxHeight());
    			smartGridPane.setMaxWidth(arg0.getMaxWidth());
    			buyGridPane = createGridPane();
    			buyGridPane.setMaxHeight(arg0.getMaxHeight());
    			buyGridPane.setMaxWidth(arg0.getMaxWidth());
    			pawnGridPane = createGridPane();
    			pawnGridPane.setMaxHeight(arg0.getMaxHeight());
    			pawnGridPane.setMaxWidth(arg0.getMaxWidth());
    			setUIControls(smartGridPane, pawnGridPane, buyGridPane, arg0);
    		    ...
    		    sp.setMaxWidth(arg0.getMaxWidth());
    	        sp.setMaxHeight(arg0.getMaxHeight());
    		    sp.setContent(vbox);
    		    tp.setContent(sp);
    			
    	        Accordion accordion = new Accordion();
    	        accordion.setMaxWidth(arg0.getMaxWidth());
    	        accordion.setMaxHeight(arg0.getMaxHeight());
    	        accordion.getPanes().add(tp);
    			
    	        Scene scene = new Scene(accordion,arg0.getMaxWidth(), arg0.getMaxHeight());
    			arg0.setScene(scene);
		...
		+ "-fx-border-color:maroon;-fx-font-weight:bold;");
		 ...
		 //Add controls to the pawnGridPane
		  mi1.setOnAction((event)->{
			     ...
			     smartGridPane.add(pawnGridPane, 0, 0,10,10);
